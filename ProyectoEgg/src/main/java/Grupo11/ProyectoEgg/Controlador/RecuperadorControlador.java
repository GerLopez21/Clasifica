...
public class RecuperadorControlador {
    ...
    @PostMapping("/guardar")
    public RedirectView guardar (@RequestParam Long dni, @RequestParam String nombre, @RequestParam String apellido, @RequestParam Long telefono, 
            @RequestParam int capacidadMax, @RequestParam int cantidadRutas) throws WebException{
        rs.crearRecuperador(dni, nombre, apellido, telefono, capacidadMax, cantidadRutas);
        return new RedirectView("/recuperadores");
    }
    
    @PostMapping("/modificar")
    public RedirectView modificar (@RequestParam Long dni, @RequestParam String nombre, @RequestParam String apellido, @RequestParam Double puntaje, 
            @RequestParam Long telefono, @RequestParam int capacidadMax, @RequestParam int cantidadRutas) throws WebException{
